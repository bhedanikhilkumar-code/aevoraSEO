...
Questions about expected behavior belong in a [GitHub issue](https://github.com/bhedanikhilkumar-code/aevoraseo/issues). Include the version, command, environment and a small redacted reproduction. Contact [Bheda Nikhilkumar](https://github.com/bhedanikhilkumar-code/Bheda-Nikhilkumar-portfolio) for consulting, training or private business context.
